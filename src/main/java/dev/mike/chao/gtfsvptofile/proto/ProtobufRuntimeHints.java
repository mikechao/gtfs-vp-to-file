...
/**
 * This class is needed for native image.
 * It registers protobuf generated class listed in META-INF/native-image/protobuf-packages.properties
 * The protobuf generated class use reflection so they and their methods need to registered as RuntimeHints
 * so the native compiler knowns the methods ahead of time
 */
@Slf4j
